...
const App = () => {
  ...
  const opacity = useRef(new Animated.Value(1)).current;
  const [isSplashVisible, setSplashVisible] = useState(true);
  const [initialRoute, setInitialRoute] = useState<keyof RootStackParamList>('Screen1');
  const [userFromGoogle, setUserFromGoogle] = useState<RootStackParamList['Screen3']['user'] | null>(null);
      ...
      <NavigationContainer>
        ...
        >
          ...
          <Stack.Screen
            name="Screen3"
            component={Screen3}
            initialParams={userFromGoogle ? { user: userFromGoogle } : undefined}
          />
          <Stack.Screen name="Screen4" component={Screen4} />
          <Stack.Screen name="Screen5" component={Screen5} />
          <Stack.Screen name="Screen6" component={Screen6} />
